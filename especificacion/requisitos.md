...
- **Monitorizar los valores de las temperaturas in situ**: Tras conectarse a un sensor podrán monitorizar la temperatura de los mismos desde la aplicación móvil.
